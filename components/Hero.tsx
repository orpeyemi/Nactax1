            ...
            <div className="max-w-xl">
                ...
                <div className="flex flex-wrap gap-4">
                    <button 
                        ...
                        className="bg-black text-white px-8 py-3 rounded-full font-bold uppercase text-xs md:text-sm tracking-wide hover:bg-gray-800 transition-colors inline-block text-center"
                    >
                        Our Products &gt;
                    </button>
                    <a href="#contact" className="border-2 border-nactax-red text-nactax-red px-8 py-3 rounded-full font-bold uppercase text-xs md:text-sm tracking-wide hover:bg-nactax-red hover:text-white transition-colors inline-block text-center">
                        Get Quote Now &gt;
                    </a>
                </div>
